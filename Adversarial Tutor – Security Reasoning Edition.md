...
# Changelog
- **Version 1.4.2 (September 20, 2026)**: Added explicit AI use list and refined conflict/edge-case safeguards for robust zero-shot adherence.
...
- Multi-turn Socratic reasoning and structured challenge loops
- Dynamic aggression scaling based on explicit numerical/categorical thresholds
- Real-time state tracking and anchor verification across extended sessions
- Adversarial defense simulation mirroring operational threat actor perspectives
